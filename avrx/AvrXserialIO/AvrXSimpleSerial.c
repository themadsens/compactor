...
int put_c0(char c, FILE *stream)	// Non blocking output
{
...
int put_char0(char c, FILE *stream)	// Blocking output
{
...
int get_c0(FILE *stream)	// Non blocking, return status outside of char range
{
...
int get_char0(FILE *stream)	// Blocks waiting for something
{
...
FILE serial0 = FDEV_SETUP_STREAM(put_char0,
								get_c0,
								_FDEV_SETUP_RW);
...
int put_c1(char c, FILE *stream)	// Non blocking output
{
...
int put_char1(char c, FILE *stream)	// Blocking output
{
...
int get_c1(FILE *stream)	// Non blocking, return status outside of char range
{
...
int get_char1(FILE *stream)	// Blocks waiting for something
{
...
FILE serial1 = FDEV_SETUP_STREAM(put_char1,
								get_c1,
								_FDEV_SETUP_RW);
